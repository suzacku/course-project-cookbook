...
### Таблица 2: **Ingredients (Ингредиенты)**
...
### Таблица 3: **Instructions (Инструкции)**
...
### Таблица 4: **RecipeCategories (Связь рецептов и категорий)**
...
### Таблица 5: **Collections (Коллекции)**

**Описание:**  хранит пользовательские коллекции рецептов
...
### Таблица 6: **CollectionRecipes (Рецепты в коллекциях)**
